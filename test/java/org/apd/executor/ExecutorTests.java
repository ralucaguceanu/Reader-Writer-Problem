...
class ExecutorTests {
    ...
    void executeWorkReaderPreferred1() {
        executeWork(20, 200, 0.8, testValues1, testValues1.length, 255, 100, 250, LockType.ReaderPreferred, 100);
    }

    @Test
    void executeWorkReaderPreferred2() {
        executeWork(20, 200, 0.8, testValues1, testValues1.length / 2, 255, 100, 250, LockType.ReaderPreferred, 150);
    }

    @Test
    void executeWorkReaderPreferred3() {
        executeWork(20, 200, 0.8, testValues1, testValues1.length * 2, 255, 100, 250, LockType.ReaderPreferred, 100);
    }

    @Test
    void executeWorkReaderPreferred4() {
        executeWork(10, 200, 0.5, testValues2, testValues2.length, 3000, 50, 300, LockType.ReaderPreferred, 100);
    }

    @Test
    void executeWorkReaderPreferred5() {
        executeWork(16, 200, 0.5, testValues2, testValues2.length / 2, 3000, 50, 300, LockType.ReaderPreferred, 150);
    }

    @Test
    void executeWorkReaderPreferred6() {
        executeWork(8, 200, 0.5, testValues2, testValues2.length * 2, 3000, 150, 150, LockType.ReaderPreferred, 100);
    }

    @Test
    void executeWorkWriterPreferred11() {
        executeWork(10, 200, 0.5, testValues1, testValues1.length, 255, 100, 250, LockType.WriterPreferred1, 150);
    }

    @Test
    void executeWorkWriterPreferred12() {
        executeWork(16, 200, 0.5, testValues1, testValues1.length / 2, 255, 100, 250, LockType.WriterPreferred1, 150);
    }

    @Test
    void executeWorkWriterPreferred13() {
        executeWork(8, 200, 0.5, testValues1, testValues1.length * 2, 255, 100, 250, LockType.WriterPreferred1, 150);
    }

    @Test
    void executeWorkWriterPreferred14() {
        executeWork(10, 200, 0.5, testValues2, testValues2.length, 3000, 50, 300, LockType.WriterPreferred1, 300);
    }

    @Test
    void executeWorkWriterPreferred15() {
        executeWork(16, 200, 0.5, testValues2, testValues2.length / 2, 3000, 50, 300, LockType.WriterPreferred1, 300);
    }

    @Test
    void executeWorkWriterPreferred16() {
        executeWork(8, 200, 0.5, testValues2, testValues2.length * 2, 3000, 150, 150, LockType.WriterPreferred1, 300);
    }

    @Test
    void executeWorkWriterPreferred21() {
        executeWork(10, 200, 0.5, testValues1, testValues1.length, 255, 100, 250, LockType.WriterPreferred2, 150);
    }

    @Test
    void executeWorkWriterPreferred22() {
        executeWork(16, 200, 0.5, testValues1, testValues1.length / 2, 255, 100, 250, LockType.WriterPreferred2, 150);
    }

    @Test
    void executeWorkWriterPreferred23() {
        executeWork(8, 200, 0.5, testValues1, testValues1.length * 2, 255, 100, 250, LockType.WriterPreferred2, 150);
    }

    @Test
    void executeWorkWriterPreferred24() {
        executeWork(10, 200, 0.5, testValues2, testValues2.length, 3000, 50, 300, LockType.WriterPreferred2, 300);
    }

    @Test
    void executeWorkWriterPreferred25() {
        executeWork(16, 200, 0.5, testValues2, testValues2.length / 2, 3000, 50, 300, LockType.WriterPreferred2, 300);
    }

    @Test
    void executeWorkWriterPreferred26() {
        executeWork(8, 200, 0.5, testValues2, testValues2.length * 2, 3000, 150, 150, LockType.WriterPreferred2, 300);
    }
}